...
export class Parallelogram {
    constructor(vertexPositions, color) {
        this.vertexPositions = new Float32Array([
            ...
            vertexPositions[3], vertexPositions[4], vertexPositions[5],
            vertexPositions[6], vertexPositions[7], vertexPositions[8],
            vertexPositions[9], vertexPositions[10], vertexPositions[11],
            vertexPositions[0], vertexPositions[1], vertexPositions[2],
            vertexPositions[6], vertexPositions[7], vertexPositions[8],
        ]);
        this.color = color;
        ...
        this.centroid = [
            (this.vertexPositions[0] + this.vertexPositions[3] + this.vertexPositions[6] + this.vertexPositions[9]) / 4,
            (this.vertexPositions[1] + this.vertexPositions[4] + this.vertexPositions[7] + this.vertexPositions[10]) / 4,
            (this.vertexPositions[2] + this.vertexPositions[5] + this.vertexPositions[8] + this.vertexPositions[11]) / 4,
        ];
